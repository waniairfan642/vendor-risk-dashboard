...
avg_risk = full_df["Risk_Score"].mean()
avg_revenue = full_df["Total_Revenue"].mean()
...
st.plotly_chart(fig_rev, use_container_width=True, key="rev_analysis")

# 🔥 Add business insight (VERY IMPORTANT)
st.info("""
